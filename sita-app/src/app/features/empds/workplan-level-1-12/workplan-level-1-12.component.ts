...
@Component({
  selector: 'app-workplan-level-1-12',
  templateUrl: './workplan-level-1-12.component.html',
  styleUrls: ['./workplan-level-1-12.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    MatCardModule,
...
export class WorkplanLevel112Component {
  workplanForm: FormGroup;
  displayedColumns: string[] = ['description', 'weight', 'keyActivities', 'indicators', 'targetDate', 'evidence', 'resources', 'actions'];
  ...
  addKRA() {
    if (this.kras.length < 10) { // Maximum 10 KRAs allowed
